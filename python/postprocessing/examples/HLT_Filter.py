...
class HLT_Filter(Module):
    ...
    def analyze(self, event):
        ...
        if self.year == '2016' and self.runP != 'H':
            ...
            good_HLT = HLT.PFHT1050 or HLT.Mu50 or HLT.OldMu100 or HLT.TkMu100 or HLT.Ele115_CaloIdVT_GsfTrkIdT or HLT.Photon200 or HLT.Ele35_WPTight_Gsf
        elif self.year == '2017' and self.runP == 'B':
            good_HLT = HLT.PFHT1050 or HLT.Mu50 or HLT.Ele35_WPTight_Gsf
        elif self.year == '2018':
            good_HLT = HLT.PFHT1050 or HLT.Mu50 or HLT.OldMu100 or HLT.TkMu100 or HLT.Ele115_CaloIdVT_GsfTrkIdT or HLT.Photon200 or HLT.Ele35_WPTight_Gsf
        else:
