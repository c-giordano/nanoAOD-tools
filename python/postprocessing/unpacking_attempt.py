...
class unpacking_vers2(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("Top_pt","F", lenVar="nTop") #Ok
        self.out.branch("Top_eta","F", lenVar="nTop")#Ok
        self.out.branch("Top_phi","F", lenVar="nTop")#Ok
        self.out.branch("Top_e","F", lenVar="nTop")#Ok
        self.out.branch("Top_M","F", lenVar="nTop")#Ok

        """Branch variabili top con nu"""

        self.out.branch("Top_nu_pt","F", lenVar="nTop")#Ok 
        self.out.branch("Top_nu_eta","F", lenVar="nTop")#Ok
        self.out.branch("Top_nu_phi","F", lenVar="nTop")#Ok
        self.out.branch("Top_nu_e","F", lenVar="nTop")#Ok
        self.out.branch("Top_nu_M","F", lenVar="nTop")#Ok
        
        """Branch indici goodJet e goodMu"""
        self.out.branch("Top_bjet_index","I", lenVar="nTop")#Ok
        self.out.branch("Top_mu_index","I", lenVar="nTop")#Ok
        self.out.branch("Top_el_index","I", lenVar="nTop")#Ok

        """Muon and bjet unboosted (top frame)"""
        
        self.out.branch("Top_Jet_unboosted_pt","F", lenVar="nTop") #Ok
        self.out.branch("Top_Jet_unboosted_eta","F", lenVar="nTop")#Ok
        self.out.branch("Top_Jet_unboosted_phi","F", lenVar="nTop")#Ok
        self.out.branch("Top_Jet_unboosted_e","F", lenVar="nTop")#Ok
        self.out.branch("Top_Jet_unboosted_M","F", lenVar="nTop")#Ok
        self.out.branch("Top_Jet_has_promptLep","O", lenVar="nTop")#Ok

        self.out.branch("Top_Lep_unboosted_pt","F", lenVar="nTop")#Ok
        self.out.branch("Top_Lep_unboosted_eta","F", lenVar="nTop")#Ok
        self.out.branch("Top_Lep_unboosted_phi","F", lenVar="nTop")#Ok
        self.out.branch("Top_Lep_unboosted_e","F", lenVar="nTop")#Ok
        self.out.branch("Top_Lep_unboosted_M","F", lenVar="nTop")#Ok
        
        self.out.branch("Top_pt_rel","F", lenVar="nTop")#Ok
        self.out.branch("Top_Is_dR_merg","I", lenVar="nTop")#Ok
        self.out.branch("Top_Costheta","F", lenVar="nTop")#Ok
        self.out.branch("Top_dR","F",lenVar="nTop")#Ok
        ...
        #aggiungere semplicemente una flag sulle var standard (che già esistono)
        self.out.branch("nGoodMu", "i")#Ok
        self.out.branch("GoodMu_pt", "F", lenVar="nGoodMu")#Ok
        self.out.branch("GoodMu_eta", "F", lenVar="nGoodMu")#Ok
        self.out.branch("GoodMu_phi", "F", lenVar="nGoodMu")#Ok
        
        self.out.branch("nGoodEl", "i")#Ok
        self.out.branch("GoodEl_pt", "F", lenVar="nGoodEl")#Ok
        self.out.branch("GoodEl_eta", "F", lenVar="nGoodEl")#Ok
        self.out.branch("GoodEl_phi", "F", lenVar="nGoodEl")#Ok
        

        self.out.branch("nGoodJet", "i")#Ok
    ...
    def analyze(self, event):
        ...
        goodjet_momentum = ROOT.TLorentzVector()
        goodjet_pt = []
        goodjet_eta = []
        goodjet_phi = []
        ...
        if len(goodJet)>0:
            ...
            for j in allJet:
                ...
                if j in goodJet:
                    ...
                    lep_char_pt.append(-999.)
                    lep_char_phi.append(-999.)
                    lep_char_eta.append(-999.)
                    lep_char_M.append(-999.)

                    lep_mu_pt.append(-999.)
                    lep_mu_phi.append(-999.)
                    lep_mu_eta.append(-999.)
                    lep_mu_M.append(-999.)
                    
                    bjet_char_pt.append(-999.)
                    bjet_char_phi.append(-999.)
                    bjet_char_eta.append(-999.)
                    bjet_char_M.append(-999.)
                    
                    bjet_mu_pt.append(-999.)
                    bjet_mu_phi.append(-999.)
                    bjet_mu_eta.append(-999.)
                    bjet_mu_M.append(-999.)

                    topsa_nu_pt.append(-999.)
                    topsa_nu_phi.append(-999.)
                    topsa_nu_eta.append(-999.)
                    topsa_nu_M.append(-999.)

                    lepsa_unboosted_pt.append(-999.)
                    lepsa_unboosted_phi.append(-999.)
                    lepsa_unboosted_eta.append(-999.)
                    lepsa_unboosted_e.append(-999.)
                    lepsa_unboosted_M.append(-999.)

                    jsa_unboosted_pt.append(-999.)
                    jsa_unboosted_phi.append(-999.)
                    jsa_unboosted_eta.append(-999.)
                    jsa_unboosted_e.append(-999.)
                    jsa_unboosted_M.append(-999.)
                    """
        ...
        if ((len(goodMu)>0 or len(goodEl)>0) and len(goodJet)>0 ):
            ...
            for j in allJet:  
                ...
                if j in goodJet:
                    ...
                    goodjet_momentum = j.p4()
                    goodjet_pt.append(goodjet_momentum.Pt())
                    goodjet_eta.append(goodjet_momentum.Eta())
                    goodjet_phi.append(goodjet_momentum.Phi())
        ...
        self.out.fillBranch("GoodJet_phi", goodel_phi)
