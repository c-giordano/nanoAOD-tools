...
python makeplot.py -y $year -L muon -f $v --sel --plot $syst -d $extratext -s #-C "lepton_pt>500"
python makeplot.py -y $year -L electron -f $v --sel --plot $syst -d $extratext -s
#EOF
:<<EOF
...
python makeplot.py -y $year -L muon --sel -f $v -C $cut --plot -S $syst -d $extratext 
python makeplot.py -y $year -L electron --sel -f $v -C $cut --plot -S $syst -d $extratext 
EOF
