...
commands_makeddmu="nohup python makedd.py --pathin "+opt.outputpath+"/"+opt.version+"/plot_merged -y 2020 --plotpath plot_"+opt.version+" -c muon "+extrasamplesopt+"--pathout "+opt.outputpath+"/"+opt.version+"/plot_explin --runoptions N --resetMF >& "+opt.outputpath+"/"+opt.version+"/makeddmu.log; " 
commands_makeddmu=commands_makeddmu+"nohup python makedd.py --pathin "+opt.outputpath+"/"+opt.version+"/plot_merged -y 2020 --plotpath plot_"+opt.version+" -c muon "+extrasamplesopt+"--pathout "+opt.outputpath+"/"+opt.version+"/plot_explin --runoptions B --resetMF >& "+opt.outputpath+"/"+opt.version+"/makeddmu.log; " 
commands_makeddmucp= "cp "+opt.outputpath+"/"+opt.version+"/plot_merged/muon/* "+opt.outputpath+"/"+opt.version+"/plot_explin/muon/ >& "+opt.outputpath+"/"+opt.version+"/makeddcpmu.log; "

commands_makeddel= "nohup python makedd.py --pathin "+opt.outputpath+"/"+opt.version+"/plot_merged -y 2020 --plotpath plot_"+opt.version+" -c electron "+extrasamplesopt+"--pathout "+opt.outputpath+"/"+opt.version+"/plot_explin --runoptions N --resetMF >& "+opt.outputpath+"/"+opt.version+"/makeddel.log; " 
commands_makeddel=commands_makeddel+"nohup python makedd.py --pathin "+opt.outputpath+"/"+opt.version+"/plot_merged -y 2020 --plotpath plot_"+opt.version+" -c electron "+extrasamplesopt+"--pathout "+opt.outputpath+"/"+opt.version+"/plot_explin --runoptions B --resetMF >& "+opt.outputpath+"/"+opt.version+"/makeddel.log; " 
commands_makeddelcp="cp "+opt.outputpath+"/"+opt.version+"/plot_merged/electron/* "+opt.outputpath+"/"+opt.version+"/plot_explin/electron/ >& "+opt.outputpath+"/"+opt.version+"/makeddcpele.log"

command_extraunc= "nohup python makecorrection.py --addsystematic -i "+opt.outputpath+"/"+opt.version+"/plot_explin/ "+"  >& "+opt.outputpath+"/"+opt.version+"/extracr.log "

commands_preparefit = "nohup python preparefit.py -m 'sum symmetrize smooth pdfeval' "+extrasamplesopt+" -i "+ opt.outputpath+"/"+opt.version+"/plot_explin -o "+ opt.outputpath+"/"+opt.version+"/plot_explin_fit "+"  >& "+opt.outputpath+"/"+opt.version+"/fitprepare.log &"
