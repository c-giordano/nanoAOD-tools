...
#p = PostProcessor('.', fnames, '', modules=[LHAPDFWeight_NNPDF(),MCweight_writer(LHAPDFs=["LHANNPDF"])], outputbranchsel=os.path.abspath('../scripts/keep_and_drop.txt'), histFileName="histOut.root", histDirName="plots", provenance=True, maxEntries=1000, fwkJobReport=True)
